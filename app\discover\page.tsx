...
export default function Discover() {
  ...
  async function loadPeople() {
    ...
    if (!data || data.length === 0) {
      setMessage(
        "No profiles yet. Invite someone to join My Gee!"
      );
    } else {
      setMessage("");
    }
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        >
          Discover people based on shared interests and
          ...
          {people.map((person) => (
            ...
            >
              ...
              >
                ...
                <div>
                  <h3 style={{ margin: 0 }}>
                    {person.display_name || "Gee member"}
                  </h3>
              ...
              >
                {person.bio ||
                  "Open to making a new connection."}
              </p>
